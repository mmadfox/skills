...
- ✅ `location: https://petstore.swagger.io/v2/swagger.json` — correct, this is an OpenAPI spec
...
### Example 4: Multiple collections per spec
...
specs:
  - domain: my-service
    ...
    collections:
      ...
      - llm_title: Payments
        location: ./specs/payments.openapi.json
```

### Example 5: With mock server
